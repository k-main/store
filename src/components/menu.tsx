...
{        open && (
        <div className='bg-slate-700 font-bold text-white absolute left-0 w-full h-[calc(100vh-2.79rem)] gap-10 flex flex-col items-center justify-center text-3xl z-10'>
          {links.map(item => (
